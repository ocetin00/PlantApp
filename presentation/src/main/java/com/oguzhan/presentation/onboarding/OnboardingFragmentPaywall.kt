 ...
 * Use the [OnboardingFragmentPaywall.newInstance] factory method to
...
class OnboardingFragmentPaywall : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OnboardingFragmentPaywall.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OnboardingFragmentPaywall().apply {
